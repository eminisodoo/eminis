        ...
        try:
            ...
            if response_data.status_code in [200, 201]:
                ...
                for response in response_data.get('etiqueta'):
                    ...
                    delivery_price = sum(
                        pickings.sale_id.mapped('order_line').filtered(lambda line: line.is_delivery == True).mapped(
                            'price_subtotal'))
                return [{
                    'exact_price': float(delivery_price or 0.0),
