...
class DeliveryCarrier(models.Model):
    ...
    def mrw_vts_send_shipping(self, pickings):
        ...
        for picking in pickings:
            ...
            etree.SubElement(receiver_direction, 'mrw:Numero').text = re.search(r'\d{1,5}', picking_partner_id.street2).group() if picking_partner_id.street2 else ""#picking_partner_id.street2 or ""
            ...
            for package_id in pickings.package_ids:
                ...
                etree.SubElement(package_request,'mrw:Alto').text = "{}".format(package_id.packaging_id and package_id.packaging_id.height or 0)
                etree.SubElement(package_request,'mrw:Largo').text = "{}".format(package_id and package_id.packaging_id.packaging_length or 0)
                etree.SubElement(package_request,'mrw:Ancho').text = "{}".format(package_id and package_id.packaging_id.width or 0)
            ...
            try:
                ...
                api = mrw_response.Response(response_data)
